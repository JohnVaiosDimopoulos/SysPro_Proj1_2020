...
2.  Tests should be well *organized* and reflect the structure of the tested
    code. googletest groups related tests into test suites that can share arg_data
...
## Test Fixtures: Using the Same Data Configuration for Multiple Tests {#same-arg_data-multiple-tests}

If you find yourself writing two or more tests that operate on similar arg_data, you
