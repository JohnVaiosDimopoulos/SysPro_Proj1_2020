...
Max_heap_node::Max_heap_node(const topk_info &info) : info(info) {
...
void Max_heap_node::insert_left(topk_info info, Max_heap_node *current_node) {
...
void Max_heap_node::insert_right(topk_info info, Max_heap_node *current_node) {
...
//==API==//
Max_heap_node * Max_heap_node::insert(topk_info info, Max_heap_node *current_node) {
...
topk_info Max_heap_node::pop(Max_heap_node *current_node) {
  topk_info info_to_return = current_node->info;
...
//==Getter==//
const topk_info &Max_heap_node::get_info() const {
  return info;
}
//==Setter==//
void Max_heap_node::set_info(const topk_info &info) {
